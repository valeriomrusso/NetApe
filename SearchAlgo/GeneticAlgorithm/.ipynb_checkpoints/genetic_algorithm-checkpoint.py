...
def mutate(individual, game_map):
    """
    Applies a mutation to an individual by randomly altering part of the path.
    ...
    if len(individual) > 1:
        ...
        next_step = get_random_valid_move(game_map, individual[mutation_index])
...
def generate_initial_population(game_map, start, target, population_size, step_limit=50):
    """
